...
export default function OwnerRiders() {
  ...
  function copyLink(rider) {
    const link = window.location.origin + "/rider/" + rider.id;
    ...
    <div>
      ...
      <div className="space-y-3">
        {riders.map((rider) => (
          <div
            key={rider.id}
            className="bg-white rounded-xl p-4 shadow-sm border border-ink/5 flex items-center justify-between flex-wrap gap-3"
          >
            <div>
